...
public class Problema_7_2 extends JFrame implements ActionListener {
	...
	public Problema_7_2() {
		...
		btnNotaMenor = new JButton("Nota Menor");
		btnNotaMenor.addActionListener(this);
		btnNotaMenor.setBounds(300, 190, 245, 23);
		contentPane.add(btnNotaMenor);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (arg0.getSource() == btnNotaMenor) {
		    actionPerfomedBtnNotaMenor(arg0);
		}
		limpieza();
	}
	protected void actionPerfomedBtnNotaMenor(ActionEvent arg0) {
	    int menorNota = an.notaMenor();
	    if (menorNota == -1) {
	        mensaje("El arreglo de notas está vacío.");
	    } else {
	        imprimir("La nota menor es: " + menorNota);
	    }
	}
